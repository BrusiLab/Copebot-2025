...
public:
  ...
  #ifdef GIROSCOPIO
  void gira(int AngoloGradi, int rpm, String direzione);
  #endif GIROSCOPIO
  #ifdef NO_GIROSCOPIO
  void gira(int AngoloGradi, int rpm);
  #endif NO_GIROSCOPIO
};
...
void Robot::gira(int AngoloGradi, int rpm, String direzione) {
...
void Robot::gira(int AngoloGradi, int rpm) {
